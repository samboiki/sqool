...
var radarChartData = {
    ...
    datasets: [
        {
            label: 'My First dataset',
            fillColor: 'rgba(0, 34, 34,0.2)',
            strokeColor: 'rgba(0, 34, 34,1)',
            pointColor: 'rgba(0, 34, 34,1)',
            pointStrokeColor: '#fff',
            pointHighlightFill: '#fff',
        ...
        },
        {
            ...
            pointHighlightFill: '#fff',
            pointHighlightStroke: 'rgba(52,143,226,1)',
            data: [88,48,60,19,96,87,100,55,72]
        }
    ]
};
...
var handleGenerateGraph = function(animationOption) {
    ...
    var radarChart = new Chart(ctx).Radar(radarChartData, {
    ...
    var lineChart = new Chart(ctx3).Line(lineChartData, {
        animation: animationOption
    });
