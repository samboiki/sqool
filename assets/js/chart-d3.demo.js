...
var multiBarHorizontalChart = function() {
    "use strict";
    ...
    nv.addGraph({
        generate: function() {
            var stackedBarChart = nv.models.multiBarChart()
                ...
                .color(["#001111","#002222","#003333","#005656","#007878","#009a9a","#008989","#00acac","#66cdcd","#b2e6e6"])
                .controlLabels({"grouped":"Group em","stacked":"Stack em"})
                .groupSpacing(0)
                .forceY([0,100]);
                //.showValues(true)           //Show bar value next to each bar.
            stackedBarChart.yAxis
                    .ticks(8); 
            var svg = d3.select('#nv-multi-bar-chart').append('svg').datum(stackedBarChartData);
            svg.transition().duration(0).call(stackedBarChart);
