    ...
    <footer class="footer">
                ...
                <div class="footer-col col-md-6 col-sm-8 newsletter">
                    <div class="footer-col-inner">
                        ...
                        <form class="subscribe-form">
                           ...
                           <?php $this->load->view('widgets/postaladdress');?>  
                </div>   
            </div>        
        </div><!--//footer-content-->
        <div class="bottom-bar">
            <div class="container">
                <div class="row">
                    <small class="copyright col-md-6 col-sm-12 col-xs-12">Copyright @ 2014 Namibia Medicines Regulatory Council | Website by <a href="#">Intrahealth Namibia</a></small>
                    <ul class="social pull-right col-md-6 col-sm-12 col-xs-12">
                        ...
                        <li class="row-end"><a href="<?php echo site_url('admins');?>"><i class="fa fa-cog"></i></a></li>
                    </ul><!--//social-->
                </div><!--//row-->
            </div><!--//container-->
        </div><!--//bottom-bar-->
