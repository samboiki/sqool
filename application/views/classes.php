...
<body>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
                        ...
                        <ul class="nav nav-pills">
                                ...
                                <li class="active"><a href="<?php echo base_url()?>classes"><strong>Classes</strong></a></li>
                                <li><a href="<?php echo base_url()?>assessment"><strong>Assessments</strong></a></li>
                                <li><a href="<?php echo base_url()?>discipline"><strong>Discipline</strong></a></li>
							...
							<div class="modal fade" id="modal-dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
                                                                                        ...
                                                                                        <div class="navbar-header text-inverse p-l-0">
                                                                                            <a href="index.html" class="navbar-brand text-inverse f-s-14"><span class="navbar-logo "></span><strong><h6 class="modal-tietle"><strong>Edit a class</strong></h6></strong></a>
                                                                                                <button type="button" class="navbar-toggle" data-click="top-menu-toggled">
                                                                                                        <span class="icon-bar"></span>
                                                                                                        <span class="icon-bar"></span>
                                                                                                        <span class="icon-bar"></span>
										...
										<div class="modal-body">
                                                                                    <form action="<?php echo base_url()?>editc" method="post" name="form_name" id="form_id" class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" novalidate="">
                                                                                        ...
                                                                                        <div class="col-md-12 col-sm-12">
                                                                                            <div class="row">
                                                                                                <div class="col-md-6 col-sm-6">
                                                                                                    <div class="stats-info"><strong>Grade</strong> </div>
                                                                                                        <select class="form-control" id="select-required" name="grade" data-parsley-required="true" data-parsley-id="8187">
                                                                                                                <option value="">Please choose</option>
                                                                                                                <?php if(isset($grd)) : foreach($grd as $row) :  ?>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="col-md-6 col-sm-6">
                                                                                                    <div class="stats-info"><strong>Subject</strong> </div>
                                                                                                        <select class="form-control" id="select-required" name="subject" data-parsley-id="8187" data-parsley-required="true">
                                                                                                                <option value="">Please choose</option>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
											<h5 class="modal-tietle"><strong>Add a class</strong></h5>
										</div>
										<div class="modal-body">
	...
	<script src="<?php echo base_url();?>/assets/plugins/DataTables/extensions/Responsive/js/dataTables.responsive.min.js"></script>
        ...
        <script src="<?php echo base_url();?>/assets/js/table-classes.js"></script>
  ...
  function editg(url) {
      ...
      $.ajax({
        url : "<?php echo site_url('edit_classes/')?>/" + url,
        type: "GET",
        dataType: "JSON",
