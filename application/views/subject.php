...
<body>
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
                        ...
                        <ul class="nav nav-pills">
                                ...
                                <li class="active"><a href="<?php echo base_url()?>subject"><strong>Subjects</strong></a></li>
							...
							<div class="modal fade" id="modal-dialog">
									...
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                                                        <h5 class="modal-tietle"><strong>Edit subject</strong></h5>
										</div>
										<div class="modal-body">
                                                                                    <form action="<?php echo base_url()?>edits" method="post" name="form_name" id="form_id" class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" novalidate="">
                                                                                        <div class="col-md-12 col-sm-12">
                                                                                            <div class="stats-info"><strong>Subject Name*</strong> </div>
                                                                                                <input class="form-control hidden" type="text" id="id" name="id" >
                                                                                                <input class="form-control" type="text" id="name" name="name" placeholder="Required" data-parsley-whitespace="trim" data-parsley-required="true" data-parsley-id="4358">
                                                                                        </div>
                                                                                        <br><br><br><br><br>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
											<h5 class="modal-tietle"><strong>Add Subject</strong></h5>
										</div>
										<div class="modal-body">
											<form action="<?php echo base_url()?>adds" method="post" name="form_name" id="form_id" class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" novalidate="">
                                                                                        <div class="col-md-12 col-sm-12">
                                                                                            <div class="stats-info"><strong>Subject Name*</strong> </div>
                                                                                                <input class="form-control hidden" type="text" id="id" name="id" >
                                                                                                <input class="form-control" type="text" id="name" name="name" placeholder="Required" data-parsley-whitespace="trim"  data-parsley-required="true" data-parsley-id="4358">
	...
	<script src="<?php echo base_url();?>/assets/plugins/DataTables/extensions/Responsive/js/dataTables.responsive.min.js"></script>
        ...
        <script src="<?php echo base_url();?>/assets/js/table-subjects.js"></script>
  ...
  function editg(url) {
      ...
      $.ajax({
        url : "<?php echo site_url('edit_subject/')?>/" + url,
        type: "GET",
        dataType: "JSON",
