...
<body>
		...
		<div id="top-menu" class="top-menu">
                ...
                <ul class="nav">
                    ...
                    <li class="has-sub active"><a href="<?php echo base_url('settings');?>"><i class="fa fa-cog"></i><span>System environment</span></a></li>
                                                                ...
                                                                <!-- begin col-8 table-->
                                                                        ...
                                                                        <div class="panel panel-inverse">
                                                                            <div class="panel-heading">
                                                                                ...
                                                                                <h4 class="panel-title">Discipline</h4>
                                                                            </div>
                                                                            <div class="panel-body height-md">

                                                                                <table id="data-tables"  class="table  table-striped table-bordered table-hover table-highlight table-checkable display " cellspacing="0" width="100%" height="100%">
                                                                                    <thead>
                                                                                        <tr>
                                                                                            <th>ID</th>
                                                                                            <th>Student</th>
							...
							<div class="modal fade" id="modal-dialog">
									...
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                                                        <h5 class="modal-tietle"><strong>Edit grade</strong></h5>
										</div>
										<div class="modal-body">
                                                                                    <form action="<?php echo base_url()?>editg" method="post" name="form_name" id="form_id" class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" novalidate="">
                                                                                        <div class="col-md-12 col-sm-12">
                                                                                            <div class="stats-info"><strong>Grade Name*</strong> </div>
                                                                                                <input class="form-control hidden" type="text" id="id" name="id" >
                                                                                                <input class="form-control" type="text" id="name" name="name" placeholder="Required" data-parsley-type="number" data-parsley-range="[1,12]" data-parsley-required="true" data-parsley-id="4358">
                                                                                        </div>
                                                                                        <br><br><br><br><br>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
											<h5 class="modal-tietle"><strong>Add grade</strong></h5>
										</div>
										<div class="modal-body">
											<form action="<?php echo base_url()?>addg" method="post" name="form_name" id="form_id" class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" novalidate="">
                                                                                        <div class="col-md-12 col-sm-12">
                                                                                            <div class="stats-info"><strong>Grade Name*</strong> </div>
                                                                                                <input class="form-control hidden" type="text" id="id" name="id" >
                                                                                                <input class="form-control" type="text" id="name" name="name" placeholder="Required" data-parsley-type="number" data-parsley-range="[1,12]" data-parsley-required="true" data-parsley-id="4358">
                                                        ...
                                                        <!-- end col-8  -->
                                                              ...
                                                              <div class="col-md-3 col-lg-3" style="">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <ul class="fa-ul">
                                                                                    ...
                                                                                    <li><i class="fa-li fa fa-circle-o"></i>default bullets in lists</<li><i class="fa-li fa fa-dot-circle-o"></i>List icons (like these)</li>
                                                                                    <li><i class="fa-li fa fa-dot-circle-o"></i>can be used</li>
                                                                                    <li><i class="fa-li fa fa-dot-circle-o text-success"></i>to easily replace</li>
                                                                ...
                                                                <div class="col-md-2 col-sm-2">
                                                                    <div class="widget widget-stats text-inverse bg-green" style="background: rgba(122, 130, 136, 0.2)!important;">
                                                                                <div class="stats-icon"><i class="fa fa-apple"></i></div>
                                                                                <div class="stats-info">

                                                                                    <strong>Offences Commited</strong>&nbsp;
                                                                                    <span class="count f-w-700" style="font-size: 13px;  color: #637281;">
                                                                                        <?php foreach($dsum as $val){
                                                                                         $id = $val->dsum;
                                                                                         echo $id;
                                                                                        }
                                                                                         ?>
                                                            ...
                                                            <!-- end col-4 -->
                                                            <span class="badge badge-inverse m-l-10"><a href="user/1" class="text-white" style="text-decoration:none;"><strong>1</strong></a> </span><a class="f-s-11 f-w-700 " style="text-decoration: none; color: black;"> 2016#2A#MAT with 221 offences</a></br>
                                                            <span class="badge badge-inverse m-l-10"><a href="user/1" class="text-white" style="text-decoration:none;"><strong>2</strong></a> </span><a class="f-s-11 f-w-700 " style="text-decoration: none; color: black;"> 2016#2A#MAT</a>
                                                        </div>
	...
	<script src="<?php echo base_url();?>/assets/plugins/DataTables/extensions/Responsive/js/dataTables.responsive.min.js"></script>
        ...
        <script src="<?php echo base_url();?>/assets/js/table-d.js"></script>
