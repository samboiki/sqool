	...
	<div id="page-container" class="page-container fade page-without-sidebar page-header-fixed page-with-top-menu">
		...
		<div id="content" class="content">
			...
			<!-- begin page-header -->
						...
						<li class="active"><a href="<?php echo base_url()?>settings"><strong>Grades</strong></a></li>
                                                                ...
                                                                <!-- begin col-8 table-->
                                                                        ...
                                                                        <div class="panel panel-inverse">
                                                                            ...
                                                                            <div class="panel-body height-md">
                                                                                ...
                                                                                <table id="data-table"  class="table  table-striped table-bordered table-hover table-highlight table-checkable display " cellspacing="0" width="100%" height="100%">
                                                                                    <thead>
                                                                                        <tr>
                                                                                            <th>ID</th>
                                                                                            <th>Grade</th>
